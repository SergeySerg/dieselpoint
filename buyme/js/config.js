...
if($('#first-languages li:first-child.selected').length) {
	var bmeData = {
		...
		"fields": "Ваше имя и фамилию(Укажите имя и фамилию), Телефон (Номер телефона)*, -Адрес доставки(Укажите город и номер отделения службы доставки)*",
...
if($('#first-languages li:nth-child(2).selected').length) {
	var bmeData = {
		...
		"fields": "Ваше ім'я та прізвище(Вкажіть ім'я та прізвище), Телефон (Номер телефону)*, -Адрес доставки(Вкажіть місто і номер відділення служби доставки)*",
