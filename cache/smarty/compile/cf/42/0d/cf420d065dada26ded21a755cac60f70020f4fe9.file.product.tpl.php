<?php /* Smarty version Smarty-3.1.19, created on 2017-03-02 22:43:32
         compiled from "E:\Webserver\domains\dieselpoint.loc\themes\dieselpoint\product.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2942758b883f40b4a82-10006276%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'cf420d065dada26ded21a755cac60f70020f4fe9' => 
    array (
      0 => 'E:\\Webserver\\domains\\dieselpoint.loc\\themes\\dieselpoint\\product.tpl',
      1 => 1488484045,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '2942758b883f40b4a82-10006276',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_58b883f4c12c41_11842794',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58b883f4c12c41_11842794')) {function content_58b883f4c12c41_11842794($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include 'E:\\Webserver\\domains\\dieselpoint.loc\\tools\\smarty\\plugins\\modifier.date_format.php';
if (!is_callable('smarty_function_math')) include 'E:\\Webserver\\domains\\dieselpoint.loc\\tools\\smarty\\plugins\\function.math.php';
if (!is_callable('smarty_function_cycle')) include 'E:\\Webserver\\domains\\dieselpoint.loc\\tools\\smarty\\plugins\\function.cycle.php';
if (!is_callable('smarty_function_counter')) include 'E:\\Webserver\\domains\\dieselpoint.loc\\tools\\smarty\\plugins\\function.counter.php';
...
" data-id="resetImages">
		...
		<div class="pb-center-column col-xs-12 col-sm-4">
			...
			<?php }?>
			<h1 itemprop="name" class="b1c-name"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value->name, ENT_QUOTES, 'UTF-8', true);?>
</h1>
			<p id="product_reference"  <?php if (empty($_smarty_tpl->tpl_vars['product']->value->reference)||!$_smarty_tpl->tpl_vars['product']->value->reference) {?> style="display: none;"<?php }?>>
				...
				<span class="editable"data-bme="Артикул" itemprop="sku"<?php if (!empty($_smarty_tpl->tpl_vars['product']->value->reference)&&$_smarty_tpl->tpl_vars['product']->value->reference) {?> content="<?php echo $_smarty_tpl->tpl_vars['product']->value->reference;?>
				...
				<div class="box-info-product">
					<div class="content_prices clearfix">
						<?php if ($_smarty_tpl->tpl_vars['product']->value->show_price&&!isset($_smarty_tpl->tpl_vars['restricted_country_mode']->value)&&!$_smarty_tpl->tpl_vars['PS_CATALOG_MODE']->value) {?>
							<!-- prices -->
							<div>
								<p class="our_price_display" data-bme="Цена за штуку" itemprop="offers" itemscope itemtype="https://schema.org/Offer"><?php if ($_smarty_tpl->tpl_vars['product']->value->quantity>0) {?><link itemprop="availability" href="https://schema.org/InStock"/><?php }?><?php if ($_smarty_tpl->tpl_vars['priceDisplay']->value>=0&&$_smarty_tpl->tpl_vars['priceDisplay']->value<=2) {?><span id="our_price_display" class="price" itemprop="price" content="<?php echo $_smarty_tpl->tpl_vars['productPrice']->value;?>
